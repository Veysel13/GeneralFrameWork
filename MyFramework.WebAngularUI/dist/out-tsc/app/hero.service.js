...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.http.get(this.heroesUrl)
            .pipe(tap(function (_) { return _this.log('fetched heroes'); }), catchError(this.handleError('getHeroes', [])));
    };
    ...
    HeroService.prototype.searchHeroes = function (term) {
        ...
        return this.http.get(this.heroesUrl + "/?name=" + term).pipe(tap(function (_) { return _this.log("found heroes matching \"" + term + "\""); }), catchError(this.handleError('searchHeroes', [])));
    };
    //////// Save methods //////////
    /** POST: add a new hero to the server */
    HeroService.prototype.addHero = function (hero) {
        var _this = this;
        return this.http.post(this.heroesUrl, hero, httpOptions).pipe(tap(function (newHero) { return _this.log("added hero w/ id=" + newHero.id); }), catchError(this.handleError('addHero')));
    };
    ...
    HeroService = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof HttpClient !== "undefined" && HttpClient) === "function" ? _a : Object, MessageService])
    ], HeroService);
    return HeroService;
}());
export { HeroService };
